...
const UserList = () => {
  ...
  const { data, refetch, isLoading, isFetching } = useQuery("allUser", () =>
    customInstance.get(
      `users?limit=${rowsPerPage}&page=${page + 1
              ...
              <Grid container justifyContent="space-between" spacing={3}>
                ...
                <Grid item>
                  <Button
                    ...
                    variant="contained"
                    onClick={() =>
                      router.push(`/dashboard/users/registerUser/add`)
                    }
                  >
                    Add
                  </Button>
                ...
                control={
                  <Switch
                    ...
                    onChange={async (e) => {
                      ...
                      await updateUser({ is_team_unique_member: e.currentTarget.checked })
                    }}
                  // disabled={}
                  />
                }
                label="Team configuration for unique menbers"
